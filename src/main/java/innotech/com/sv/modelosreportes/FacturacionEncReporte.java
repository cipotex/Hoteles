...
public class FacturacionEncReporte {
    ...
    public FacturacionEncReporte() {
		super();
	}
    
    public FacturacionEncReporte(long idocupacion, String tipohabitacion, String codigohabitacion, String periodocobro,
